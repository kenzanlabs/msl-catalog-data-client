...
public class SongsQuery {
   ...
   * @return ResultSet
   */
  public static ResultSet getSongsAlbumsByArtist(final QueryAccessor queryAccessor,
      final UUID artistId, final Optional<Integer> limit) {
    if (limit.isPresent()) {
   ...
   * @return ResultSet
   */
  public static ResultSet getSongsArtistByAlbum(final QueryAccessor queryAccessor,
      final UUID albumId, final Optional<Integer> limit) {
    if (limit.isPresent()) {
