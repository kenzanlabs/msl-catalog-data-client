...
public interface QueryAccessor {
  ...
  public static String FACETED_ARTISTS_QUERY =
      "SELECT * FROM artists_by_facet WHERE facet_name = :facet_name AND content_type = 'Artist'";
  public static String FACETED_SONGS_QUERY =
      "SELECT * FROM songs_by_facet WHERE facet_name = :facet_name AND content_type = 'Song'";
  public static String FACETED_ALBUMS_QUERY =
      "SELECT * FROM albums_by_facet WHERE facet_name = :facet_name AND content_type = 'Album'";

  public static String FEATURED_ARTISTS_QUERY =
      "SELECT * FROM featured_artists WHERE hotness_bucket = 'Hotness01' AND content_type = 'Artist'";
  public static String FEATURED_SONGS_QUERY =
      "SELECT * FROM featured_songs WHERE hotness_bucket = 'Hotness01' AND content_type = 'Song'";
  public static String FEATURED_ALBUMS_QUERY =
      "SELECT * FROM featured_albums WHERE hotness_bucket = 'Hotness01' AND content_type = 'Album'";
  ...
  public ResultSet songsArtistByAlbumWithLimit(@Param("album_id") UUID album_id,
      @Param("max") int limit);
  ...
  public ResultSet songsAlbumsByArtistWithLimit(@Param("artist_id") UUID artist_id,
      @Param("max") int limit);
  ...
  public ResultSet albumArtistBySongWithLimit(@Param("song_id") UUID song_id,
      @Param("max") int limit);
