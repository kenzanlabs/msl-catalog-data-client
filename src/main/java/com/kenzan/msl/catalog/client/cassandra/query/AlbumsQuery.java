...
public class AlbumsQuery {
   ...
   * @return ResultSet
   */
  public static ResultSet getAlbums(final QueryAccessor queryAccessor,
      final Optional<String> facet, final Optional<Integer> limit) {
   ...
   * @return ResultSet
   */
  public static ResultSet getAlbumArtistBySong(final QueryAccessor queryAccessor, UUID songId,
